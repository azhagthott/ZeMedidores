...
public interface PostResult {
    ...
    Call<ResponseBody> postResultadoTest(
            ...
            @Nullable @Part MultipartBody.Part foto_uso_imanes_1,
            @Nullable @Part MultipartBody.Part foto_uso_imanes_2,
            @Nullable @Part MultipartBody.Part foto_uso_imanes_3,
            @Nullable @Part MultipartBody.Part foto_invertir_tomas_1,
            @Nullable @Part MultipartBody.Part foto_invertir_tomas_2,
            @Nullable @Part MultipartBody.Part foto_invertir_tomas_3,
            @Nullable @Part MultipartBody.Part foto_perfora_cupula_1,
            @Nullable @Part MultipartBody.Part foto_perfora_cupula_2,
            @Nullable @Part MultipartBody.Part foto_perfora_cupula_3,
            @Nullable @Part MultipartBody.Part foto_corta_engranaje_1,
            @Nullable @Part MultipartBody.Part foto_corta_engranaje_2,
            @Nullable @Part MultipartBody.Part foto_corta_engranaje_3,
            @Nullable @Part MultipartBody.Part foto_uso_alambre_1,
            @Nullable @Part MultipartBody.Part foto_uso_alambre_2,
            @Nullable @Part MultipartBody.Part foto_uso_alambre_3,
            @Nullable @Part MultipartBody.Part foto_prensado_1,
            @Nullable @Part MultipartBody.Part foto_prensado_2,
            @Nullable @Part MultipartBody.Part foto_prensado_3,
            @Nullable @Part MultipartBody.Part foto_otro_1_1,
            @Nullable @Part MultipartBody.Part foto_otro_1_2,
            @Nullable @Part MultipartBody.Part foto_otro_1_3,
            @Nullable @Part MultipartBody.Part foto_instalacion_paralela_1,
            @Nullable @Part MultipartBody.Part foto_instalacion_paralela_2,
            @Nullable @Part MultipartBody.Part foto_instalacion_paralela_3,
            @Nullable @Part MultipartBody.Part foto_bypass_1,
            @Nullable @Part MultipartBody.Part foto_bypass_2,
            @Nullable @Part MultipartBody.Part foto_bypass_3,
            @Nullable @Part MultipartBody.Part foto_otro_2_1,
            @Nullable @Part MultipartBody.Part foto_otro_2_2,
            @Nullable @Part MultipartBody.Part foto_otro_2_3
    );
}
